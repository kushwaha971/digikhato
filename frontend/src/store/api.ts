...
export const api = createApi({
  ...
  tagTypes: ["Auth", "Borrower", "Loan", "Collection", "Dashboard", "Report", "Onboarding", "Account", "Team", "Notification", "CustomerLedger", "Note", "Location", "Jewellery", "ModuleAccessRequest", "TenantModules"],
  endpoints: () => ({}),
});
