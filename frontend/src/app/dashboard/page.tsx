  ...
  return (
    <Screen title="Dashboard">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
        {(isAdmin || isCollector) && (
          <Link href="/collections/today" className="app-panel p-4 card-clickable flex flex-col items-center gap-2 text-center">
        ...
        <Link href="/borrowers" className="app-panel p-4 card-clickable flex flex-col items-center gap-2 text-center">
        ...
        <Link href="/reports" className="app-panel p-4 card-clickable flex flex-col items-center gap-2 text-center">
        ...
        {isAdmin && (
          <Link href="/borrowers/add" className="app-panel p-4 card-clickable flex flex-col items-center gap-2 text-center">
      ...
      {!summaryLoading && (summary?.upcoming_due_loans?.length ?? 0) > 0 && (
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/notifications" className="text-xs text-primary-600 font-medium hover:underline">View all</Link>
          </div>
          <div className="space-y-2">
            {summary!.upcoming_due_loans.map((loan) => (
              <Link key={loan.id} href={`/borrowers/${loan.borrower_uuid ?? loan.borrower_id}`} className="block">
      ...
      {(recentCollections?.results?.length ?? 0) > 0 && (
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/collections" className="text-xs text-primary-600 font-medium hover:underline">View all</Link>
          </div>
          <div className="space-y-2">
