  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {(title || breadcrumb || actions) && (
        <div className="sticky top-0 z-30 bg-canvas/90 backdrop-blur-md border-b border-border flex-shrink-0">
          <div className={containerClass}>
            <div className="py-3 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              {actions && (
                <div className="flex items-center gap-2 flex-shrink-0 self-end sm:self-start">{actions}</div>
              )}
            </div>
          </div>
        </div>
