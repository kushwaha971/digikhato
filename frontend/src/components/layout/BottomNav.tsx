...
export function BottomNav() {
  ...
  let allTabs = MAIN_TABS;
  if (isSuperAdmin) allTabs = SUPER_ADMIN_TABS;
  else if (isBorrower) allTabs = BORROWER_TABS;
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 lg:hidden border-t border-border bg-surface/95 backdrop-blur-md">
      <ul className="grid gap-0 h-16" style={{ gridTemplateColumns: `repeat(${visibleTabs.length}, 1fr)` }}>
        {visibleTabs.map((tab) => {
